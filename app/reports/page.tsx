                  ...
                  <Box key={r.id} sx={{ mb: 2 }}>
                    <Table size="small">
                      <TableBody>
                        ...
                        <TableRow><TableCell sx={{ borderColor: "var(--icsp-nav-border)", fontWeight: 600 }}>Kazık Sayısı (Ad.)</TableCell><TableCell sx={{ borderColor: "var(--icsp-nav-border)" }}>{r.daily_pile_count ?? r.total_pile_count ?? r.concrete_poured ?? "—"}</TableCell></TableRow>
                        <TableRow><TableCell sx={{ borderColor: "var(--icsp-nav-border)", fontWeight: 600 }}>Beton dökülen (Ad.)</TableCell><TableCell sx={{ borderColor: "var(--icsp-nav-border)" }}>{r.concrete_poured ?? "—"}</TableCell></TableRow>
                        <TableRow><TableCell sx={{ borderColor: "var(--icsp-nav-border)", fontWeight: 600 }}>Kalan kazık (Ad.)</TableCell><TableCell sx={{ borderColor: "var(--icsp-nav-border)" }}>{r.remaining_piles != null && r.remaining_piles !== "" ? r.remaining_piles : "—"}</TableCell></TableRow>
