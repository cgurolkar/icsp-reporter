                  ...
                  <Box key={r.id} sx={{ mb: 2 }}>
                    <Table size="small">
                      <TableBody>
                        ...
                        <TableRow><TableCell sx={{ borderColor: "var(--icsp-nav-border)", fontWeight: 600 }}>İmalat (m)</TableCell><TableCell sx={{ borderColor: "var(--icsp-nav-border)" }}>{r.total_production_summary ?? r.total_production ?? "—"}</TableCell></TableRow>
                        <TableRow><TableCell sx={{ borderColor: "var(--icsp-nav-border)", fontWeight: 600 }}>Yapılan kazık</TableCell><TableCell sx={{ borderColor: "var(--icsp-nav-border)" }}>{r.daily_pile_count ?? r.total_pile_count ?? "—"}</TableCell></TableRow>
                        <TableRow><TableCell sx={{ borderColor: "var(--icsp-nav-border)", fontWeight: 600 }}>Beton dökülen</TableCell><TableCell sx={{ borderColor: "var(--icsp-nav-border)" }}>{r.concrete_poured ?? "—"}</TableCell></TableRow>
                        <TableRow><TableCell sx={{ borderColor: "var(--icsp-nav-border)", fontWeight: 600 }}>Kalan kazık</TableCell><TableCell sx={{ borderColor: "var(--icsp-nav-border)" }}>{r.remaining_piles ?? "—"}</TableCell></TableRow>
                        ...
                        <TableRow><TableCell sx={{ borderColor: "var(--icsp-nav-border)", fontWeight: 600 }}>Mazot notu</TableCell><TableCell sx={{ borderColor: "var(--icsp-nav-border)" }}>{(r.daily_fuel_usage as string) || "—"}</TableCell></TableRow>
                        {r.notes && (
